...
<body data-app-title="BookWorkbench Local App">
  ...
  <script>
    ...
    const state = { workspace: null, projects: [], project: null, annotations: [], discussions: [], audit: [], currentFile: null, currentChapter: null, lastPatch: null, lastPreview: null, activeView: "dashboard", selectedAnnotationId: null, activeAnnotationTab: "annotations", ruleFilter: "all", selectedRuleId: null, diffReasonCollapsed: false };
