...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .annotation-card { border: 1px solid var(--line); border-radius: 14px; padding: 16px; margin-bottom: 12px; background: #fff; line-height: 1.55; }
    ...
    .ai-item { display: grid; grid-template-columns: 42px 1fr auto; gap: 10px; align-items: center; padding: 12px 0; border-bottom: 1px solid #edf1f6; line-height: 1.45; }
